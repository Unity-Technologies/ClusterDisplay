...
namespace Unity.ClusterDisplay.MissionControl
{
        ...
        where T : IIncrementalCollectionObject
    {
        ...
        /// <summary>
        /// Fake changes to the collection by calling <see cref="SomethingChanged"/>.
        /// </summary>
        /// <remarks>Useful to wakeup a part of code waiting for changes when trying to exit the wait loop.</remarks>
        public void FakeChanges() { SomethingChanged?.Invoke(this); }
        ...
        public bool Remove(Guid key)
        {
            ...
            T? removedObject;
#endif
            if (m_PublicCollection.TryGetValue(key, out removedObject))
            {
        ...
        public void ApplyDelta(IncrementalCollectionUpdate<T> update)
        {
            ...
            foreach (Guid removedKey in update.RemovedObjects)
            {
                ...
                T? removedObject;
#endif
                if (m_PublicCollection.TryGetValue(removedKey, out removedObject))
                {
...
#region ICollection<KeyValuePair> implementation
        ...
        bool ICollection<KeyValuePair<Guid, T>>.Contains(KeyValuePair<Guid, T> item)
        {
            ...
            T? value;
#endif
            if (m_PublicCollection.TryGetValue(item.Key, out value))
            {
