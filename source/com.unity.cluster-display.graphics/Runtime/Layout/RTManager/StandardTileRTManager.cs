...
namespace Unity.ClusterDisplay.Graphics
{
    ...
    {
        public override RenderTexture GetSourceRT(int width, int height, GraphicsFormat format = GraphicsFormat.B8G8R8A8_SRGB)
        {
            bool resized = 
                m_SourceRT != null && 
        ...
        public override RenderTexture GetPresentRT(int width, int height, GraphicsFormat format = GraphicsFormat.B8G8R8A8_SRGB)
        {
            bool resized = 
                m_PresentRT != null && 
        ...
        public override RenderTexture GetBackBufferRT(int width, int height, GraphicsFormat format = GraphicsFormat.B8G8R8A8_SRGB)
        {
            bool resized = 
                m_BackBufferRT != null && 
