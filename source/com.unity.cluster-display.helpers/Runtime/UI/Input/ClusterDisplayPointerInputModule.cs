...
namespace Unity.ClusterDisplay.Helpers
{
    ...
    public abstract class ClusterDisplayPointerInputModule : PointerInputModule
    {
        ...
        private bool TryPerformRaycast (PointerEventData pointerEventData, out RaycastResult raycast)
        {
            ...
            #if UNITY_EDITOR
            if (selectRaycastedUI && raycast.gameObject != null)
        ...
        private void PollInput()
        {
            ...
            propagatePointerState:
            ClusterDisplayCanvasPointerManager.PropagatePointerActiveState(hit);
            ClusterDisplayCanvasPointerManager.PropagatePointerPosition(raycastResult.worldPosition);
        }
