...
namespace Unity.ClusterDisplay
{
    ...
    internal static partial class ReflectionUtils
    {
            ...
            bool sort = false)
        {
            #if UNITY_EDITOR
            methodInfos = sort ?
                SortMethods(UnityEditor.TypeCache.GetMethodsWithAttribute(attributeType)) :
                UnityEditor.TypeCache.GetMethodsWithAttribute(attributeType).ToArray();
            #else
            ...
            methodInfos = sort ? SortMethods(list) : list.ToArray();
            #endif
