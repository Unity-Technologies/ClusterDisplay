                    ...
                    return typeValue switch
                        {
                            ...
                            "launch" => JsonSerializer.Deserialize<LaunchCommand>(rootElement, options),
                            "abort" => JsonSerializer.Deserialize<AbortCommand>(rootElement, options),
                            "clear" => JsonSerializer.Deserialize<ClearCommand>(rootElement, options),
