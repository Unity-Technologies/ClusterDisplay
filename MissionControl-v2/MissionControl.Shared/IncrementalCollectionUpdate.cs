...
namespace Unity.ClusterDisplay.MissionControl
{
    ...
    public class IncrementalCollectionUpdate<T> where T : IIncrementalCollectionObject
    {
        ...
        /// </summary>
        public IEnumerable<T> UpdatedObjects { get; init; } = Enumerable.Empty<T>();

        /// <summary>
        /// Identifier of removed objects.
        /// </summary>
        public IEnumerable<Guid> RemovedObjects { get; init; } = Enumerable.Empty<Guid>();
        ...
        public UInt64 NextUpdate { get; init; }
