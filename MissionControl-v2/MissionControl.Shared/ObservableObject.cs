...
namespace Unity.ClusterDisplay.MissionControl
{
    ...
    public abstract class ObservableObject
    {
        ...
        /// </remarks>
        public event Action<ObservableObject>? OnObjectChanged;

        /// <summary>
        /// Method to be called manually by the code that modify the ObservableObject to inform observers that the
