...
namespace GfxQuadroSync
{
	...
	void WriteFileDebug_Advanced(const char* const message,
		const bool append)
	{
		std::ofstream myfile;
		...
		if (append)
		{
			myfile.open("C:/NVIDIA_QuadroSync_DebugFile_New.txt", std::ios_base::app | std::ios_base::out);
		}
		else
		{
			myfile.open("C:/NVIDIA_QuadroSync_DebugFile_New.txt");
		}
