...
{
    public class RPCLateUpdateTest : RPCMonoBehaviourBase
    {
        const RPCExecutionStage k_BeforeStage = RPCExecutionStage.BeforeLateUpdate;
        const RPCExecutionStage k_AfterStage = RPCExecutionStage.AfterLateUpdate;
