...
{
    public class RPCFixedUpdateTest : RPCMonoBehaviourBase
    {
        const RPCExecutionStage k_BeforeStage = RPCExecutionStage.BeforeFixedUpdate;
        const RPCExecutionStage k_AfterStage = RPCExecutionStage.AfterFixedUpdate;
