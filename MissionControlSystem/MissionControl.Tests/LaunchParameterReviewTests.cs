...
namespace Unity.ClusterDisplay.MissionControl.MissionControl
{
    public class LaunchParameterReviewTests
    {
        ...
        public void SerializeDefault()
        {
            ...
            var deserialized = JsonSerializer.Deserialize<LaunchParameterForReview>(serializedParameter, Json.SerializerOptions);
        ...
        public void DeepCloneFull()
        {
            ...
            var serializeClone = JsonSerializer.Deserialize<LaunchParameterForReview>(
